...
function startMe() {
  ...
  Lampa.SettingsApi.addParam({
                ...
                param: {
                    ...
                    type: 'input', 
                    values: '',
                    placeholder: 'ÐÐ°Ð¿Ñ€Ð¸Ð¼ÐµÑ€: reyohoho.space:9912',
                    default: ''
                },
                field: {
                    name: 'ÐÐ´Ñ€ÐµÑ ÑÐµÑ€Ð²ÐµÑ€Ð°',
                    description: 'ÐÐ°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð´Ð»Ñ Ð²Ð²Ð¾Ð´Ð°, ÑÐ¼ÐµÐ½Ñƒ ÑÐµÑ€Ð²ÐµÑ€Ð° Ð¼Ð¾Ð¶Ð½Ð¾ Ð±ÑƒÐ´ÐµÑ‚ ÑÐ´ÐµÐ»Ð°Ñ‚ÑŒ ÐºÐ½Ð¾Ð¿ÐºÐ¾Ð¹ Ð² Ð²ÐµÑ€Ñ…Ð½ÐµÐ¼ Ð±Ð°Ñ€Ðµ'
                },
    ...
    Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'ÐŸÐ¾ÑÑ‚Ð¾ÑÐ½Ð½Ñ‹Ð¹ Ñ€ÐµÐ´Ð¸Ñ€ÐµÐºÑ‚',
                description: 'Ð§Ñ‚Ð¾Ð±Ñ‹ Ð¾Ñ‚ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚Ð¾ÑÐ½Ð½Ñ‹Ð¹ Ñ€ÐµÐ´Ð¸Ñ€ÐµÐºÑ‚ Ð·Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ ÐºÐ»Ð°Ð²Ð¸ÑˆÑƒ Ð’ÐÐ˜Ð— Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ' 
            }
   });
